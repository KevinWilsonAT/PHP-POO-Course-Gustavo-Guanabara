...
class Fighter {
    ...
    public function display(){
        echo "<p>From this side of the ring we have the Fighter ". $this->getName().", ";
        echo "From ". $this->getNationality().", ". $this->getAge()." years old.<br>";
        echo "With a height of ". $this->getHeight()."m and a weight of ". $this->getWeight()."kgs.<br>";
        echo "This fighter has ". $this->getWins()." wins, ". $this->getLosses()." losses and ". $this->getDraws()." draws.<br><br>";
    }
